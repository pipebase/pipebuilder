...
pub const REGISTER_KEY_API_NODE_ID_PREFIX: &str = "/api";
pub const REGISTER_KEY_BUILDER_NODE_ID_PREFIX: &str = "/builder";
pub const REGISTER_KEY_SCHEDULER_NODE_ID_PREFIX: &str = "/scheduler";
