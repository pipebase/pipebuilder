...
pub(crate) const DISPLAY_ID_WIDTH: usize = 32;
pub(crate) const DISPLAY_VERSION_WIDTH: usize = 16;
pub(crate) const DISPLAY_BUILD_STATUS_WIDTH: usize = 8;
pub(crate) const DISPLAY_TIMESTAMP_WIDTH: usize = 12;
pub(crate) const DISPLAY_ADDRESS_WIDTH: usize = 16;
pub(crate) const DISPLAY_MESSAGE_WIDTH: usize = 32;
